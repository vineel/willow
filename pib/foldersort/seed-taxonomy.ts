...
export const SEED_PROFILES: SeedProfile[] = [
  ...
  },
  {
    ...
    enabled: true,
    description:
      "bills, invoices, and receipts — recurring service/utility bills, subscription charges, order and purchase confirmations, payment receipts, and account statements",
    llm_hint:
      "Route here: recurring bills (utilities, phone, insurance, rent, subscriptions), invoices, payment/transaction receipts (Stripe, PayPal, Venmo, Apple/Google Play, App Store), purchase and order confirmations/receipts from any retailer, and credit-card or bank statement-ready notices. This is routine financial paperwork Vineel wants archived, not urgent. Do NOT route here: security/fraud alerts, password resets, low-balance or overdraft warnings, or anything requiring action from Vineel — those should stay in the inbox.",
    rules: [
      { field: "subject", operator: "contains", value: "your receipt", priority: 15 },
      { field: "subject", operator: "contains", value: "receipt from", priority: 15 },
      { field: "subject", operator: "contains", value: "payment receipt", priority: 15 },
      { field: "subject", operator: "contains", value: "your invoice", priority: 15 },
      { field: "subject", operator: "contains", value: "invoice is ready", priority: 15 },
      { field: "subject", operator: "contains", value: "bill is ready", priority: 15 },
      { field: "subject", operator: "contains", value: "billing statement", priority: 15 },
      { field: "subject", operator: "contains", value: "statement is ready", priority: 15 },
      { field: "subject", operator: "contains", value: "payment confirmation", priority: 15 },
      { field: "subject", operator: "contains", value: "order confirmation", priority: 15 },
      { field: "subject", operator: "contains", value: "thank you for your order", priority: 15 },
      { field: "subject", operator: "contains", value: "thank you for your purchase", priority: 15 },
      { field: "from_domain", operator: "equals", value: "paddle.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "audible.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "pnc.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "email.apple.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "e-zpassny.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "parkmobile.io", priority: 10 },
      { field: "from_domain", operator: "equals", value: "deltadentalcoversme.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "digitalocean.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "dollarshaveclub.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "ecrm-mail.verizon.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "paypal.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "godaddy.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "mytix.njtransit.com", priority: 10 },
      { field: "from_domain", operator: "equals", value: "lazparking.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "northwestregisteredagent.com", priority: 10 },
      { field: "from_domain", operator: "ends_with", value: "att-mail.com", priority: 10 },
    ],
  },
  {
